...
figure.update_layout(title="Google Candlestick", xaxis_rangeslider_visible=False)
figure.show()
...
"""
figure = px.scatter(data, x='Date', y='Close', range_x=['2021-12-01', '2022-12-01'],
...
# https://sanjayjsw05.medium.com/time-series-analysis-complete-tutorial-for-beginners-part-3-5c235acf9399
